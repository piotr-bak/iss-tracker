const serverErrorCodes: Map<number, string> = new Map([
    // Official 4xx Codes
    [400, "Bad Request"],
    [401, "Unauthorized"],
    ...
    [
        418,
        "I'm a Teapot: User attempted to brew coffee with a teapot. The resulting entity body MAY be short and stout.",
    ],
    ...
    [
        527,
        "Railgun Error: Used to indicate an interrupted connection between Cloudflare and the origin server's Railgun server.",
    ],
